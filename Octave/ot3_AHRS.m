...
## algorithm classes with OpenTag data. The OpenTag data sensor axes and
## signs are adjusted to match the example data set provided with Madgwick
## code and assuming a 'NED' orientation of the tag.
...
## The script first plots the example sensor data, then processes the data
## through the algorithm and plots the output as Euler angles.
...
## Correct magoffset
Magnetometer = [Magnetometer (INER.mag(:, k) - magoffset(k)) * magsign(k)];
